...
class sfOauthPhirehose extends OauthPhirehose
{
   ...
   *
   * @param string $username Access token for Twitter user generated by application
   * @param string $password Access token secret for Twitter user generated by application
